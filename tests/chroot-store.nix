...
pkgs.testers.nixosTest {
  ...
  testScript =
    ...
    ''
      ...
      # Now test that we can actually download the NAR
      # This tests the file access mapping from virtual to real store
      print("Testing NAR download...")
      ...
      print("SUCCESS: Chroot store test passed!")
    '';
}
